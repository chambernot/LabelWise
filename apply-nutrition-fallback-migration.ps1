# Fallback nutrition migration entrypoint
...
Write-Host '========================================'
Write-Host 'Fallback nutrition migration'
Write-Host '========================================'
...
Write-Host 'Fallback nutrition migration applied successfully.' -ForegroundColor Green
